import { Bt as DataUtils, Fr as LinearSRGBColorSpace, In as HalfFloatType, kr as LinearFilter, vn as FloatType, zt as DataTextureLoader } from "./three.module-BQ0TNVQb.js";
	...
	*/
	parse(buffer) {
		const rgbe_read_error = 1, rgbe_write_error = 2, rgbe_format_error = 3, rgbe_memory_error = 4, rgbe_error = function(rgbe_error_code, msg) {
			...
			if (scanline_width < 8 || scanline_width > 32767 || 2 !== buffer[0] || 2 !== buffer[1] || buffer[2] & 128) return new Uint8Array(buffer);
		...
		switch (this.type) {
			...
			case HalfFloatType:
				...
				type = HalfFloatType;
				break;
			default: throw new Error("THREE.HDRLoader: Unsupported type: " + this.type);
		}
		return {
			width: w,
			height: h,
