import { Eo as ShapePath, Rr as Loader, hn as FileLoader } from "./three.module-BQ0TNVQb.js";
//#region node_modules/three/examples/jsm/loaders/FontLoader.js
/**
...
function createPath(char, scale, offsetX, offsetY, data) {
	...
	if (glyph.o) {
		...
		for (let i = 0, l = outline.length; i < l;) switch (outline[i++]) {
			case "m":
